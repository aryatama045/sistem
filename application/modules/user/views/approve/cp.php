...
<div class="row">
		<div class="col-12">
			<h1><?= $page_title ?> - Cuti Pengganti</h1>
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-5">
							<form class="form-side" action="<?= base_url('user/approve/save_action_cp') ?>" method="post">
...
<div class="modal fade" id="editModal" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?= base_url('user/approve/edit_action_cp') ?>" method="post">
...
<div class="modal fade" id="removeModal" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?= base_url('user/approve/remove_action_cp') ?>" method="post">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"> </h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
...
<?php echo $this->load->assets('approve', 'cp', 'js');  ?>