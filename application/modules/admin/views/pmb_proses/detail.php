...
<div class="page-title-container">
    <div class="row">
        ...
        <div class="col-12 col-md-5 d-flex align-items-end justify-content-end">
            <a href="" class="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
...
<div class="row gx-4 gy-2">
    <ul class="nav nav-tabs separator-tabs ml-0 mb-5" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link " id="thrid-tab" data-bs-toggle="tab" href="#thrid" role="tab"
                aria-controls="thrid" aria-selected="false">RIWAYAT PEMBAYARAN</a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="thrid" role="tabpanel" aria-labelledby="thrid-tab">
            <div class="row">
