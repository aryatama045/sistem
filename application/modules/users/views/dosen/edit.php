	...
	<div class="col">
		...
		<div class="card">
			<div class="card-body">
                ...
                <form class="row g-3" action="<?= base_url($mod.'/'.$func.'/edit/'.$dosen['nip']); ?>" method="POST">
                    ...
                    <div class="col-12 col-md-6" >
                        ...
                        <input type="text" class="form-control" required name="nidn" value="<?= $dosen['nidn'] ?>" />
                    </div>

                    <div class="col-12 col-md-12">
                        <label class="form-label text-black"><strong>Nama Lengkap Dosen<span style="color:red">*</span> dan Gelar </strong></label>
                        <div class="input-group">
                            <input type="text" name="gelar_depan"  class="form-control" <?= ($dosen['gelar_depan'])?'value="'.$dosen['gelar_depan'].'"':'placeholder="Gelar Depan"';?> />
                            <input type="text" required name="nama" class="form-control" <?= ($dosen['nama'])?'value="'.$dosen['nama'].'"':'placeholder="Nama Lengkap"';?>  />
                            <input type="text" required name="gelar_blk" class="form-control" <?= ($dosen['gelar_blk'])?'value="'.$dosen['gelar_blk'].'"':'placeholder="Gelar Belakang"';?> />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select class="form-control" name="agama" required>
                            <option value="<?= $dosen['agama'] ?>" >-- <?= $dosen['nm_agama'] ?> --</option>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select class="form-control" name="kota" required>
                            <option value="<?= $dosen['kota'] ?>" >-- <?= $dosen['nm_kota'] ?> --</option>
                    ...
                    <div class="col-12 col-md-12 mb-5">
                        ...
                        <textarea name="alamat" row="3" class="form-control"><?= $dosen['alamat'] ?></textarea>
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <select class="form-control" name="jabatan" required>
                            <option value="<?= $dosen['jabatan'] ?>" >-- <?= $dosen['nm_jabatan'] ?> --</option>
                    ...
                    <div class="col-12 col-md-3" >
                        ...
                        <input class="form-control" name="tgl_masuk" value="<?= date('Y-m-d', strtotime($dosen['tgl_masuk'])) ?>" required id="selectTanggalAwal" />
                    </div>

                    <div class="col-12 col-md-3" >
                        <label class="form-label text-black"><strong>Tanggal Menjabat<span style="color:red">*</span></strong></label>
                        <input class="form-control" name="tmt_jabatan" value="<?= date('Y-m-d', strtotime($dosen['tmt_jabatan'])) ?>" required id="selectTanggalAkhir" />
                    </div>
