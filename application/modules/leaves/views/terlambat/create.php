...
<?php //$this->load->assets('terlambat','create', 'css');  ?>
<div class="row">
	<div class="col-12">
		<div class="card mb-2">
			<div class="card-body">

				<h5 class="mb-4"><i class="iconsminds-clock-back"></i> 
					PENGAJUAN KETERLAMBATAN</h5>
				...
				<form role="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
							...
							<input hidden type="text" name="status_absensi_id" value="000000000061" class="form-control"  readonly>
					...
					<div class="col-12 data-tables-hide-filter">
						<div class="card">
							<div class="card-body">
								<table id="TableCuti" class="table table-striped table-condensed field_wrapper">
									<thead>
										<tr>
											<th>Tanggal & Jam Keterlambatan</th>
											<!-- <th>
										...
										<tr>
											<td>
												<div class="input-group ">
													...
													<input type="text" id="datetimepicks" class="form-control" name="tgl_tdk_masuk[]" value="<?= date('Y-m-d H:i:s');?>" placeholder="Pilih Tanggal">
												</div>
											</td>
											<!-- <td>
												<div id="dvPassport" style="display: none">
													<div class="input-group ">
														...
														<input type="text" id="datetimepicks2" class="form-control" name="tgl_kembali[]" value="<?= date('Y-m-d H:i:s');?>" placeholder="Pilih Tanggal">
													</div>
												</div>
												<div id="AddPassport">
													Kembali
											...
											<!-- <td><a id="addnew" class="btn btn-outline-primary btn-sm" href="javascript:void(0);">Tambah Keterlambatan</a></td> -->
										</tr>
									</tbody>
								</table>
							</div>
...
<?php echo $this->load->assets('terlambat', 'create', 'js');  ?>
