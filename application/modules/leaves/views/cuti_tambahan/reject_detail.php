	...
	<div class="col-12">
		<div class="card mb-2">
			...
			<div id="messages"></div>
				...
				<form role="form" action="<?php base_url('leaves/cuti_tambahan/reject_detail') ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-6">
									<input type="date" id="tgl_doc" name="tgl_doc" class="form-control" readonly value="<?= $header_data['header']['tgl_doc'] ?>" placeholder="Pilih Tanggal Awal Berlaku">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-5 col-form-label">N.I.P</label>
								<div class="col-sm-6">
									<input type="text" id="nip" name="nip" class="form-control" value="<?= $header_data['header']['nip'] ?>" readonly>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-5 col-form-label">TANGGAL MASUK</label>
								<div class="col-sm-6" type="text">
									<input id="tgl_awal" readonly name="tgl_awal" class="form-control" value="<?= $header_data['header']['tgl_awal'] ?>" placeholder="Pilih Tanggal Masuk">
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div hidden class="form-group row">
								...
								<div class="col-sm-6">
									<input id="jam_masuk" name="jam_masuk" class="form-control"  disabled></textarea>
								</div>
							</div>
							<div hidden class="form-group row">
								<label class="col-sm-5 col-form-label">JAM KELUAR : </label>
								<div class="col-sm-6">
									<input id="jam_keluar" name="jam_keluar" class="form-control" disabled></textarea>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6" >
									<input id="tgl_awal" readonly name="jml_hari" class="form-control" value="<?= $header_data['header']['jml_hari'] ?>" placeholder="Pilih Tanggal Masuk">
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<textarea id="keterangan" disabled readonly name="keterangan" class="form-control" value="<?= $header_data['header']['keterangan'] ?>"><?= $header_data['header']['keterangan'] ?></textarea>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-5"><b>REJECT KOMENTAR</b></div>
								<div class="col-sm-6">
										<textarea name="reject_komentar" required class="form-control"></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group row mb-0">
							<div class="col-sm-5">
								<button onclick="history.go(-1); return false;" class="btn btn-primary mb-2 mt-2"> Kembali</button>
