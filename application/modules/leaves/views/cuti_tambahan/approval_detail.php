					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input id="jam_masuk" name="jam_masuk" placeholder="<?= $jam_masuk ?>" class="form-control"  disabled>
									<?php if(empty($jam_masuk)) { ?>
									<span class="text-small text-warning"> Jam Absen Belum Ditarik ke Absensi, <br> oleh hrd</span>
									<?php } ?>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input id="jam_keluar" name="jam_keluar" placeholder="<?= $jam_keluar ?>" class="form-control" disabled>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<?php
										$tgl_masuk 		= strtotime($tgl_masuk.' '.$jam_masuk);
										$tgl_keluar 	= strtotime($tgl_keluar.' '.$jam_keluar);
									?>
									<input id="selisih" name="selisih" placeholder="<?= selisih_jam($tgl_masuk, $tgl_keluar) ?>" class="form-control" disabled>
								</div>
							</div>
