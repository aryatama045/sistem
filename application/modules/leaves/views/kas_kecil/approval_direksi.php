...
<style>
	...
	<div class="row">
		<div class="col-12">
			<h1>Approval Kas Kecil - Direksi</h1>
	...
	<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<form action="<?= base_url('leaves/kas_kecil/reject_direksi') ?>" method="post">
...
<?php echo $this->load->assets('kas_kecil', 'approval_direksi', 'js');  ?>
