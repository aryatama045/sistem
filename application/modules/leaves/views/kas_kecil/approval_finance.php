...
<style>
	...
	<div class="row">
		<div class="col-12">
			<h1>Approval Kas Kecil - Finance</h1>
							...
							<div class="row">
								<div class="col-md-7">
									<div class="form-group row ">
										<label class="col-sm-4 col-form-label">NO REQ.</label>
										<div class="col-sm-8">
											<input placeholder="Search by NO REQ." id="no_req" name="no_req" type="text" class="form-control" >
										</div>
									</div>
									<div class="form-group row ">
										<label class="col-sm-4 col-form-label">NAMA REQ.</label>
										<div class="col-sm-8">
											<input placeholder="Search by Nama REQ." id="nama_req" name="nama_req" type="text" class="form-control" >
										</div>
									</div>
	...
	<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<form action="<?= base_url('leaves/kas_kecil/reject_finance') ?>" method="post">
...
<?php echo $this->load->assets('kas_kecil', 'approval_finance', 'js');  ?>
