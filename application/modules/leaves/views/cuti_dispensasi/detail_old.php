				...
				<form role="form" action="<?php base_url('leaves/cuti/approve_action') ?>" method="post" class="form-horizontal">
					<div class="row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-7">
									<div class="input-group ">
										...
										<input type="text" class="form-control" name="noreff" readonly placeholder="<?= $header_data['header']['tgl_klaim'] ?>">
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							...
							<div class="form-group row">
								<div class="col-sm-5 col-form-label">Lampiran 1</div>
								<div class="col-sm-6">
							...
							<div class="form-group row">
								<div class="col-sm-5 col-form-label">Lampiran 2</div>
								<div class="col-sm-6">
									<a class="test-popup-link"
							...
							<div class="form-group row">
								<div class="col-sm-5 col-form-label">Lampiran 3</div>
								<div class="col-sm-6">
									<a class="test-popup-link"
...
<?php echo $this->load->assets('cuti_dispensasi', $js, 'js');  ?>
