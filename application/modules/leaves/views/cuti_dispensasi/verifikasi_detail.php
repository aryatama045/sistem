				...
				<form role="form" action="<?php base_url('leaves/cuti_dispensasi/verifikasi_detail') ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group row">
								<label class="col-sm-5 col-form-label">NIP/NAMA</label>
								<div class="col-sm-7">
										<input type="text" class="form-control" readonly placeholder="<?= $header_data['header']['nip'] ?> - <?= $header_data['header']['nama_lengkap'] ?>">
								</div>
							</div>
							<div class="form-group row">
