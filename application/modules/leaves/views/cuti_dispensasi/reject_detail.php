	...
	<div class="col-12">
		<div class="card mb-2">
			...
			<div id="messages"></div>
				...
				<form role="form" action="<?php base_url('leaves/cuti_dispensasi/reject_detail') ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
...
<?php //echo $this->load->assets('cuti_dispensa', 'approval', 'js');  ?>
