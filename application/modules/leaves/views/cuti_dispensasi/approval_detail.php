	...
	<div class="col-12">
		<div class="card mb-2">
			...
			<div id="messages"></div>
				...
				<?php endif; ?>
				<h3 class="mb-4">Detail Cuti Dispensasi - <?= $header_data['header']['no_dok_cuti'] ?></h3>
				<div class="separator mb-4"></div>
				<form role="form" action="<?php base_url('leaves/cuti/approve_detail') ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group row">
								...
								<div class="col-sm-7">
									<input type="text"  class="form-control" readonly value="<?= $header_data['header']['nip'] ?>">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-5 col-form-label">NAMA</label>
								<div class="col-sm-7">
									<input type="text"  class="form-control" readonly value="<?= $header_data['header']['nama_lengkap'] ?>">
								</div>
							</div>
							<div class="form-group row">
											...
											<tr>
												<td>
													<div class="input-group ">
														...
														<input id="keterangan" class="form-control" hidden name="posisi_hari[]" value="<?= $val['hr'] ?>" type="text" />
													</div>
												</td>
