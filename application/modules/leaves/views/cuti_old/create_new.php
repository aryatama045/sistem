						...
						<div class="col-lg-6">
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									...
									<select name="jumlah_hari"  class="form-control select2-single" data-width="100%" required>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										...
										<?php if($tambahan['sisa_cuti_tambahan']=='' || $tambahan['sisa_cuti_tambahan']=='0') { ?>
											...
											<input type="text" hidden name="mulai_berlaku_tambahan" value="<?php echo $tambahan['tgl_mulai_berlaku'] ?>">
											<input type="text" hidden name="akhir_berlaku_tambahan"  value="<?php echo $tambahan['tgl_akhir_berlaku'] ?>">
											<?php } ?>
										</label>
									</div>
								</div>
