							...
							<div class="card drop-area">
								<div class="card-body">
									...
									<div class="center">
										<div class="form-input">
											<div class="preview2">
												<img data-fancybox="gallery" id="file-ip-2-preview">
											</div>
											<label class="btn btn-primary" for="file-ip-2">Select Image</label>
											<input type="file" class="form-control-file" name="file_2" id="file-ip-2" accept="image/*" onchange="showPreview2(event);">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card drop-area">
								<div class="card-body">
									...
									<div class="center">
										<div class="form-input">
											<div class="preview3">
												<img data-fancybox="gallery" id="file-ip-3-preview">
											</div>
											<label class="btn btn-primary" for="file-ip-3">Select Image</label>
											<input type="file" class="form-control-file" name="file_3" id="file-ip-3" accept="image/*" onchange="showPreview3(event);">
										</div>
									</div>
								</div>
							</div>
