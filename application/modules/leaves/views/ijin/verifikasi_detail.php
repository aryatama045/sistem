	...
	<div class="col-12">
		<div class="card mb-2">
			...
			<div id="messages"></div>
				...
				<?php endif; ?>
				<h3 class="mb-4">Verifikasi Ijin - <?= $header_data['header']['no_dok_tdk_masuk'] ?></h3>
				<div class="separator mb-4"></div>
				<form role="form" action="<?php base_url('leaves/ijin/verifikasi_detail') ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group row">
								...
								<div class="col-sm-6">
									...
									<input type="text" hidden class="form-control" name="tdk_masuk_h_id_r" value="<?= $header_data['header']['tdk_masuk_h_id'] ?>" readonly>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
										<textarea name="keterangan" readonly class="form-control"><?= $header_data['header']['keterangan'] ?></textarea>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
						<h4 class="mb-4"> <b>Lampiran </b></label></h4>
							<div class="form-group row">
								<div class="col-sm-4">

									<a data-fancybox="gallery" data-src="<?php echo base_url('upload/ijin/'.$header_data['header']['file_1']) ?>" >
										<span class="badge badge-pill mb-4 badge-theme-2"> Detail</span>
					...
					<hr>
						...
						<div class="col-12 data-tables-hide-filter">
							<div class="card">
								<div class="card-body">
									<table id="TableCuti" class="table table-responsive-lg table-striped table-condensed">
										<thead>
					...
					<div class="row">
						<div class="form-group row mb-0">
							<div class="col-sm-4">
								<a href="<?= base_url('leaves/ijin/verifikasi'); ?>" class="btn btn-primary mb-0"> Kembali</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		...
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Reject - <?= $header_data['header']['no_dok_tdk_masuk'] ?></h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			<span aria-hidden="true">&times;</span>
			</button>
		</div>
			<form action="<?php base_url('leaves/ijin/verifikasi_detail') ?>" method="post" class="form-horizontal">
...
<?php echo $this->load->assets('ijin', 'approval_detail', 'js');  ?>
