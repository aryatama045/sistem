	...
	<div class="col-12">
		<div class="card mb-2">
			...
			<div id="messages"></div>
				...
				<form id="approve_detail" role="form" action="<?php base_url('leaves/ijin/approve_detail') ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group row">
								...
								<div class="col-sm-6">
									...
									<input type="text" hidden class="form-control" id="nip_user" name="nip_user" value="<?= $header_data['header']['nip'] ?>" readonly>
						...
						<div class="col-lg-6">
							...
							<?php if($header_data['header']['ket_status_absensi'] == 'IJIN TERLAMBAT DISPENSASI') { ?>
								<div class="form-group row" >
									<div class="col-sm-5">JAM HADIR (Finger)</div>
									<div class="col-sm-6">
											...
											<tr>
												<td>
													<div class="input-group ">
														...
														<input type="text" class="form-control " id="datetimepicker23" hidden name="tgl_tdk_masuk[]" value="<?= $val['tgl_tdk_masuk'] ?>" readonly>
