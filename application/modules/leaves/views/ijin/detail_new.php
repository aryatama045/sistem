        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="row social-image-row gallery">
                    ...
                    <?php if($header_data['header']['file_2'] != $header_data['header']['file_1'] && $header_data['header']['file_2'] != $header_data['header']['file_3']) { ?>
                    <div class="col-4">
                    ...
                    <?php if($header_data['header']['file_3'] != $header_data['header']['file_1'] && $header_data['header']['file_3'] != $header_data['header']['file_2']) { ?>
                    <div class="col-4">
