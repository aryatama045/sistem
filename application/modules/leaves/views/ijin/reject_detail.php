	...
	<div class="col-12">
		<div class="card mb-2">
			...
			<div id="messages"></div>
				...
				<?php endif; ?>
				<h3 class="mb-4">Reject Detail Ijin - <?= $header_data['header']['no_dok_tdk_masuk'] ?></h3>
				<div class="separator mb-4"></div>
				<form role="form" action="<?php base_url('leaves/ijin/reject_detail') ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
											...
											<tr>
												<td>
													<div class="input-group ">
														...
														<input type="text" class="form-control " disable value="<?= $val['tgl_tdk_masuk'] ?> | <?= $val['jam_ijin'] ?>" readonly>
					...
					<div class="row">
						<div class="form-group row mb-0">
							<div class="col-sm-5">
								<button onclick="history.go(-1); return false;" class="btn btn-primary mb-3"> Kembali</button>
							</div>
							<div class="col-sm-5">
