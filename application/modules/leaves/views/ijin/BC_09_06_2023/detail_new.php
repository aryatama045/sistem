...
<div class="row">
    <div class="col-12">
        <h1>NO. DOC : <span class="small"><?= $header_data['header']['no_dok_tdk_masuk'] ?></span></h1>
...
<div class="row justify-content-center">
    ...
    $class='col-12 col-md-10 col-lg-8 col-xl-8'; ?>
    <div class="<?= $class; ?>">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p class="text-muted mb-2">Status Cuti</p>
                <p class="mb-3 list-item-heading" >
                ...
                <table id="TableCutiList" class="table table-striped ">
                    ...
                    <?php if(isset($header_data['detail_item'])):?>
                        ...
                        <tr>
                            <td>
                                <?= $val['tgl_tdk_masuk'] ?> | <?= $val['jam_ijin'] ?>
                            ...
                            <td>
                                <?= $val['tgl_tdk_masuk'] ?> | <?= $val['jam_kembali'] ?>
                                <div hidden class="input-group ">
                                    <span class="input-group-text input-group-append input-group-addon ">
                                        <i class="simple-icon-calendar"></i>
                                    </span>
                ...
                <table id="TableCuti" class="table table-striped table-condensed">
                    ...
                    <tbody>
                        <?php if(isset($urutan_data)):?>
                            ...
                            <?php endforeach;?>
                                <?php if($header_data['header']['ket_status_absensi'] == "SAKIT SURAT KETERANGAN") { ?>
                                <tr>
            ...
            <div class="card-body">
                ...
                <div class="row social-image-row gallery">
                    <div class="col-4">
                        ...
                        <a class="test-popup-link" href="<?php echo base_url('upload/ijin/'.$header_data['header']['file_1']) ?>">
                            <img class="img-fluid border-radius"
                                src="<?php echo base_url('upload/ijin/'.$header_data['header']['file_1']) ?>" />
                        </a>
                    </div>
                    <div class="col-4">
                        <h5><span class="small"> Lampiran 2</span></h5>
                        <a class="test-popup-link" href="<?php echo base_url('upload/ijin/'.$header_data['header']['file_2']) ?>">
                            <img class="img-fluid border-radius"
                                src="<?php echo base_url('upload/ijin/'.$header_data['header']['file_2']) ?>" />
                        </a>
                    </div>
                    <div class="col-4">
                        <h5><span class="small"> Lampiran 3</span></h5>
                        <a class="test-popup-link" href="<?php echo base_url('upload/ijin/'.$header_data['header']['file_3']) ?>">
                            <img class="img-fluid border-radius"
                                src="<?php echo base_url('upload/ijin/'.$header_data['header']['file_3']) ?>" />
                        </a>
                    </div>
                </div>
            </div>
    ...
    <?php if($status_hrd['no_dok']==NULL && empty($status_hrd['no_dok']) && $header_data['header']['ket_status_absensi'] =='SAKIT SURAT KETERANGAN') { ?>
            ...
            <div class="card-body">
                ...
                <div class="row ">
                    <div class="col-12 col-xl-12 drop-area-container">
                        <form action="<?= base_url('leaves/ijin/reupload_image')?>" method="post" enctype="multipart/form-data">
                            <input type="text" hidden class="form-control" name="id_doc" value="<?= $header_data['header']['tdk_masuk_h_id'] ?>" readonly>
                            <input type="text" hidden class="form-control" name="no_docs" value="<?= $header_data['header']['no_dok_tdk_masuk'] ?>" readonly>
