$(document).ready(function() {
    ...
    function add_input_field(count) {
        ...
        if (count > 1) {
            ...
            html += '<td><input type="datetime-local" name="tgl_tdk_masuk[]" class="form-control item_name" /></td>';

            html += '<td><div id="dvPassport" style="display: none"> <div class="input-group "><input type="datetime-local" class="form-control" name="tgl_kembali[]" placeholder="Pilih Tanggal"></div> </div><div id="AddPassport">Kembali</div></td>';
