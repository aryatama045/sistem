	...
	<div class="col-12">
		<div class="card mb-2">
			...
			<div id="messages"></div>
				...
				<?php endif; ?>
				<h5 class="mb-4">Reject Detail - <?= $header_data['header']['no_dok_tdk_masuk'] ?></h5>
				<div class="separator mb-4"></div>
				<form role="form" action="<?php base_url('leaves/cuti/reject_detail') ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group row">
								...
								<div class="col-sm-7">
									...
									<?php if($this->session->userdata('nama_login') != '99999999'){ ?>
											...
											<tr>
												<td>
													<div class="input-group ">
														...
														<input type="text" disabled class="form-control " name="tgl_tdk_masuk[]" value="<?= $val['tgl_tdk_masuk'] ?>" readonly>
