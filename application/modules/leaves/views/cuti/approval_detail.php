	...
	<div class="col-12">
		<div class="card mb-2">
			...
			<div id="messages"></div>
				...
				<form role="form" action="<?php base_url('leaves/cuti/approval_detail/'.$header_data['header']['no_dok_tdk_masuk']) ?>" method="post" class="form-horizontal">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group row">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control"  placeholder="<?= $header_data['header']['nip'] ?>" readonly>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-5 col-form-label">NAMA</label>
								<div class="col-sm-7">
									<input type="text" class="form-control"  placeholder="<?= $header_data['header']['nama_lengkap'] ?>" readonly>
								</div>
							</div>
							<div class="form-group row">
							...
							<fieldset class="form-group">
								<div class="row">
									...
									<div class="col-sm-4">
										...
										<input type="text" hidden name="saldo_awal_normatif" value="<?php echo $normatifs['saldo_awal'] ?>">
										<input type="text" hidden name="saldo_normatif" value="<?php echo $normatifs['saldo_tahunan'] ?>">
										<input type="text" hidden name="id_saldo_normatif" value="<?php echo $normatifs['saldo_cuti_normatif_id'] ?>">
										<input type="text" hidden name="mulai_berlaku" value="<?php echo $header_data['header']['mulai_berlaku_normatif'] ?>">
										<input type="text" hidden name="akhir_berlaku"  value="<?php echo $header_data['header']['akhir_berlaku_normatif'] ?>">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										...
										<input type="text" hidden name="saldo_awal_bonus" value="<?php echo $bonus['saldo_awal'] ?>">
										<input type="text" hidden name="saldo_bonus" value="<?php echo $bonus['saldo_bonus'] ?>">
										<?php if($header_data['header']['sisa_saldo_bonus'] !=0 && $header_data['header']['sisa_saldo_bonus'] !='' ) { ?>
											<input type="text" hidden name="id_saldo_bonus" value="<?php echo $bonus['saldo_cuti_bonus_id'] ?>">
											<input type="text" hidden name="mulai_berlaku" value="<?php echo $header_data['header']['mulai_berlaku_bonus'] ?>">
											<input type="text" hidden name="akhir_berlaku"  value="<?php echo $header_data['header']['akhir_berlaku_bonus'] ?>">
										<?php } ?>
										</label>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-sm-4">
										<label class="form-check-label">
											...
											<input type="text" hidden name="saldo_awal_tambahan" value="<?php echo $tambahan['saldo_awal'] ?>">
											<?php if($header_data['header']['sisa_saldo_tambahan'] !=0 && $header_data['header']['sisa_saldo_tambahan'] !='' ) { ?>
												<input type="text" hidden name="id_saldo_tambahan" value="<?php echo $tambahan['saldo_cuti_tambahan_id'] ?>">
												<input type="text" hidden name="mulai_berlaku" value="<?php echo $header_data['header']['mulai_berlaku_tambahan'] ?>">
												<input type="text" hidden name="akhir_berlaku"  value="<?php echo $header_data['header']['akhir_berlaku_tambahan'] ?>">
											<?php } ?>
										</label>
									</div>
								</div>
											...
											<tr>
												<td>
													<div class="input-group ">
														...
														<input type="text" class="form-control " hidden name="status_absen[]" value="<?= $val['status_absen'] ?>" readonly>
