			...
			<div class="card-body">
                ...
                <form class="row g-3" action="<?= base_url($mod.'/'.$func.'/tambah'); ?>" method="POST">
                    ...
                    <div class="col-12 col-md-6">
                        <label class="form-label"><strong> Tahun Ajaran & Semester<span style="color:red">*</span></strong></label>
                        <select name="kd_ta" required class="form-select">
                            <option value=""> -- Select Tahun Ajaran</option>
                            <?php foreach ($getTa as $val) { ?>
                                <option value="<?= $val['kd_ta'] ?>"> <?= $val['ta'] ?> || Semester: <?= $val['smt'] ?>-<?= $val['smt_gage'] ?>   </br>   </option>
                            <?php } ?>
                        </select>
                    </div>

                    <div class="col-12 col-md-6">
                        <label class="form-label"><strong>Keterangan<span style="color:red">*</span></strong></label>
                        <input type="text" class="form-control" required name="keterangan" placeholder="Input Keterangan" />
                    </div>
