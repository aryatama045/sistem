	...
	<div class="col">
		...
		<div class="card">
			<div class="card-body">
                ...
                <form class="row g-3" action="<?= base_url($mod.'/'.$func.'/edit/'.$role['id']); ?>" method="POST">
                    <div class="col-12 col-md-6">
                        <label class="form-label text-black"><strong>Role Name<span style="color:red">*</span></strong></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" required class="form-select">
                            <option value="<?= $role['status'] ?>">-- <?= $role['sts'] ?> --</option>
