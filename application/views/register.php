                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('auth/register') ?>" method="post">
                                ...
                                <label class="form-group has-float-label mb-4">
                                    <input type="text" class="form-control" name="nama_login" id="nama_login" placeholder="Nip" autocomplete="off" required tabIndex="1" autofocus />
                                    <span>NIP</span>
                                </label>

                                <label class="form-group has-float-label mb-4">
									<span id="nama_lengkap"><input type="text" class="form-control" disabled/> </span>
                                    <span>Nama</span>
                                </label>
                                ...
                                <label class="form-group has-float-label mb-4">
                                    <input type="password" class="form-control" name="cpassword" id="cpassword" placeholder="Confirm Password" autocomplete="off" required tabIndex="3" />
                                    <span>Confirm Password</span>
                                </label> -->
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="<?= base_url('auth/login') ?>"> Back to Login !!</a>
                                    <button tabIndex="4" class="btn btn-primary btn-sm btn-shadow" type="submit"> REGISTER</button>
                                </div>
                            </form>
                        </div>
                    </div>
